...
#include "Model.h"
#include "edl/bindless_image_buffer.h"
...
public:
    ...
    void loadFileRecord(const FileRecord& record);
    ...
    void loadModel(const rapidjson::GenericObject<false, rapidjson::Value>& model);

    void updateModels(const glm::mat4& proj, const glm::mat4& view);
